...
class NodeTypesControllerTest < ActionController::TestCase
  ...
  test "should create node_type" do
    assert_difference('NodeType.count') do
      post :create, node_type: { description: @node_type.description, downloaded: @node_type.downloaded, name: @node_type.name }
    end
  ...
  test "should update node_type" do
    patch :update, id: @node_type, node_type: { description: @node_type.description, downloaded: @node_type.downloaded, name: @node_type.name }
    assert_redirected_to node_type_path(assigns(:node_type))
  end
