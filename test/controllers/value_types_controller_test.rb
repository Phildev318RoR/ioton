...
class ValueTypesControllerTest < ActionController::TestCase
  ...
  test "should create value_type" do
    assert_difference('ValueType.count') do
      post :create, value_type: { description: @value_type.description, downloaded: @value_type.downloaded, name: @value_type.name }
    end
  ...
  test "should update value_type" do
    patch :update, id: @value_type, value_type: { description: @value_type.description, downloaded: @value_type.downloaded, name: @value_type.name }
    assert_redirected_to value_type_path(assigns(:value_type))
  end
