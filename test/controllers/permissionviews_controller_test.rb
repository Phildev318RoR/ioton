...
class PermissionviewsControllerTest < ActionController::TestCase
  setup do
    @permissionview = permissionviews(:one)
  end
  ...
  test "should create permissionview" do
    assert_difference('Permissionview.count') do
      post :create, permissionview: { permission_id: @permissionview.permission_id, viewmenu_id: @permissionview.viewmenu_id }
    end
  ...
  test "should update permissionview" do
    patch :update, id: @permissionview, permissionview: { permission_id: @permissionview.permission_id, viewmenu_id: @permissionview.viewmenu_id }
    assert_redirected_to permissionview_path(assigns(:permissionview))
  end
