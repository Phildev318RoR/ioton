...
module Iotlogin
  class PermissionsControllerTest < ActionController::TestCase
    setup do
      @permission = iotlogin_permissions(:one)
    ...
    test "should create permission" do
      assert_difference('Permission.count') do
        post :create, permission: { description: @permission.description, name: @permission.name }
      end
    ...
    test "should update permission" do
      patch :update, id: @permission, permission: { description: @permission.description, name: @permission.name }
      assert_redirected_to permission_path(assigns(:permission))
    end
