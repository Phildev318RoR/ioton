...
AmCharts.checkSize = function() {
    var a = AmCharts.charts;
    if (a)
        for (var b = 0; b < a.length; b++) a[b].validateSize()
};
AmCharts.bezierX = 3;
AmCharts.bezierY = 6;
...
AmCharts.AxisBase = AmCharts.Class({
    ...
    fixAxisPosition: function() {
        var a = this.position;
        "H" == this.orientation ? ("left" == a && (a = "bottom"), "right" == a && (a =
            "top")) : ("bottom" == a && (a = "left"), "top" == a && (a = "right"));
        this.position = a
    },
    draw: function() {
        var a = this.chart;
    ...
    addGuide: function(a) {
        ...
        a = AmCharts.processObject(a, AmCharts.Guide, this.theme);
    ...
    choosePeriod: function(a) {
        var b = AmCharts.getPeriodDuration(this.periods[a].period, this.periods[a].count),
            ...
            d = this.periods;
        return this.timeDifference < b && 0 < a ? d[a - 1] : c <= this.gridCountR ? d[a] : a + 1 < d.length ? this.choosePeriod(a +
            1) : d[a]
    },
    parseDatesDraw: function() {
        var a, b = this.chart,
            ...
            e, f = "",
            g = AmCharts.extractPeriod(this.minPeriod),
            h = AmCharts.getPeriodDuration(g.period, g.count),
            k, l, m, n, p, r = this.firstDayOfWeek,
        ...
        var t, z = this.gridAlpha,
            ...
            w = u.period,
            u = u.count,
            y = AmCharts.getPeriodDuration(w, u);
        y < h && (w = g.period, u = g.count, y = h);
        g = w;
        "WW" == g && (g = "DD");
        this.stepWidth = this.getStepWidth(this.timeDifference);
        var A = Math.ceil(this.timeDifference /
                y) + 5,
            C = k = AmCharts.resetDateToMin(new Date(this.startTime - y), w, u, r).getTime();
        g == w && 1 == u && this.centerLabelOnFullPeriod && (m = y * this.stepWidth);
        this.cellWidth = h * this.stepWidth;
        n = Math.round(k / y);
        h = -1;
        n / 2 == Math.round(n / 2) && (h = -2, k -= y);
        n = this.firstTime;
        var B = 0;
        a && 1 < u && (t = this.chooseMinorFrequency(u), x = AmCharts.getPeriodDuration(w, t));
        if (0 < this.gridCountR)
            for (a = h; a <= A; a++) {
                p = n + y * (a + Math.floor((C - n) / y)) - B;
                "DD" == w && (p += 36E5);
                p = AmCharts.resetDateToMin(new Date(p), w, u, r).getTime();
                "MM" == w && (e = (p - k) / y, 1.5 <= (p -
                    k) / y && (p = p - (e - 1) * y + AmCharts.getPeriodDuration("DD", 3), p = AmCharts.resetDateToMin(new Date(p), w, 1).getTime(), B += y));
                e = (p - this.startTime) * this.stepWidth;
                e = this.rotate ? e + (this.x - this.viX) : "date" == this.type ? this.axisWidth - e + (this.y - this.viY) : e + (this.y - this.viY);
                f = !1;
                this.nextPeriod[g] && (f = this.checkPeriodChange(this.nextPeriod[g], 1, p, k, g));
                k = !1;
                f && this.markPeriodChange ? (f = this.dateFormatsObject[this.nextPeriod[g]], this.twoLineMode && (f = this.dateFormatsObject[g] + "\n" + f, f = AmCharts.fixBrakes(f)), k = !0) : f = this.dateFormatsObject[g];
                q || (k = !1);
                this.currentDateFormat = f;
                f = AmCharts.formatDate(new Date(p), f, b);
                if (a == h && !c || a == A && !d) f = " ";
                this.labelFunction && (f = this.labelFunction(f, new Date(p), this, w, u, l).toString());
                this.boldLabels && (k = !0);
                l = new this.axisItemRenderer(this, e, f, !1, m, 0, !1, k);
                this.pushAxisItem(l);
                l = k = p;
                if (!isNaN(t))
                    for (e = 1; e < u; e += t) this.gridAlpha = this.minorGridAlpha, f = p + x * e, f = AmCharts.resetDateToMin(new Date(f), w, t, r).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth), this.pushAxisItem(f);
                this.gridAlpha =
                    z
            }
    },
    ...
    checkPeriodChange: function(a, b, c, d, e) {
        ...
        b = AmCharts.resetDateToMin(f, a, b, g).getTime();
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        AmCharts.setCN(a, this.labelsSet,
        ...
        if (this.logarithmic) {
            var d = this.treatZeroAs,
                e = this.getMin(0, this.data.length - 1);
            0 < d && 0 == e && (this.minReal =
                e = d);
            if (0 >= e || 0 >= this.minimum) {
        ...
        var f, g, h = a.dx,
            ...
            d = !1,
            e = this.logarithmic;
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) d = !0;
        else {
            ...
            var t = 0;
            1 > this.step && -1 <
                this.step && (t = AmCharts.getDecimals(this.step));
            ...
            if (0 < w) {
                ...
                for (g = this.fillAlpha = 0; g < w; g++) {
                    var A = u[g],
                        C = NaN,
                        B = A.above;
                    isNaN(A.toValue) || (C = this.getCoordinate(A.toValue), x = new this.axisItemRenderer(this, C, "", !0, NaN, NaN, A), this.pushAxisItem(x, B));
                    var I = NaN;
                    isNaN(A.value) || (I = this.getCoordinate(A.value), x = new this.axisItemRenderer(this, I, A.label, !0, NaN, (C - I) / 2, A), this.pushAxisItem(x, B));
                    isNaN(C - I) || (x = new this.guideFillRenderer(this, I, C, A), this.pushAxisItem(x, B), x = x.graphics(), A.graphics = x, A.balloonText && this.addEventListeners(x, A))
                }
                this.fillAlpha = y
            }
            this.exponential = !1;
            for (g = f; g < r; g += p) u = AmCharts.roundTo(this.step *
                g + this.min, t), -1 != String(u).indexOf("e") && (this.exponential = !0, String(u).split("e"));
            this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
            var t = this.step,
                D, u = this.minorGridAlpha;
            this.minorGridEnabled && (D = this.getMinorGridStep(t, this.stepWidth * t));
            if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                ...
                for (g = f; g < r; g += p)
                    if (c = t * g + this.minCalc, e && this.max -
                        this.min > 5 * this.min && (c -= this.min), c = AmCharts.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
                        if (isNaN(z) || Number(AmCharts.toFixed(c, z)) == c) {
                            !0 === e && (0 === c && (c = this.minReal), q > this.logGridLimit && (c = Math.pow(10, g)));
                            x = this.formatValue(c, !1, g);
                            Math.round(g / l) != g / l && (x = void 0);
                            if (0 === g && !m || g == r - 1 && !n) x = " ";
                            f = this.getCoordinate(c);
                            x = new this.axisItemRenderer(this, f, x, void 0, void 0, void 0, void 0, this.boldLabels);
                            this.pushAxisItem(x);
                            if (c == this.baseValue && "radar" != a.type) {
                                ...
                                x = this.viX;
                                w = this.viY;
                                "H" == this.orientation ? 0 <= f && f <= y + 1 && (H = [f, f, f + h], S = [A, 0, k]) : 0 <= f && f <= A + 1 && (H = [0, y, y + h], S = [f, f, f + k]);
                                H && (f = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), f = AmCharts.line(a.container, H, S, this.gridColor, f, 1, this.dashLength), f.translate(x, w), this.grid0 = f, a.axesSet.push(f), f.toBack(), AmCharts.setCN(a, f, this.bcn + "zero-grid-" + this.id), AmCharts.setCN(a, f, this.bcn + "zero-grid"))
                            }
                            if (!isNaN(D) && 0 < u && g < r - 1) {
                                f = this.gridAlpha;
                                this.gridAlpha = this.minorGridAlpha;
                                for (x = 1; x < t / D; x++) w =
                                    this.getCoordinate(c + D * x), w = new this.axisItemRenderer(this, w, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(w);
                                this.gridAlpha = f
                            }
                        }
            q = this.baseValue;
            ...
            e && q < this.minReal && (q = this.minReal);
        ...
        q = this.labelsSet;
        this.positionTitle();
        "radar" != a.type ? (a = this.viX, D = this.viY, b.translate(a, D), q.translate(a, D)) : e.toFront();
        !this.visible || d ? (b.hide(), e.hide(), q.hide()) : (b.show(), e.show(), q.show());
    ...
    formatValue: function(a, b, c) {
        ...
        d ? (b = -1 == String(a).indexOf("e") ? a.toExponential(15) :
            String(a), c = b.split("e"), b = Number(c[0]), c = Number(c[1]), b = AmCharts.roundTo(b, 14), 10 == b && (b = 1, c += 1), b = b + "e" + c, 0 === a && (b = "0"), 1 == a && (b = "1")) : (e && (d = String(a).split("."), d[1] ? (f.precision = d[1].length, 0 > c && (f.precision = Math.abs(c)), b && 1 < a && (f.precision = 0)) : f.precision = -1), b = this.usePrefixes ? AmCharts.addPrefix(a, g.prefixesOfBigNumbers, g.prefixesOfSmallNumbers, f, !b) : AmCharts.formatNumber(a, f, f.precision));
        this.duration && (b = AmCharts.formatDuration(a, this.duration, "", this.durationUnits, this.maxInterval, f));
        "date" == this.type && (b = AmCharts.formatDate(new Date(a), this.currentDateFormat, g));
    ...
    recalculate: function() {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (d.valueAxis == this) {
                ...
                if (l = a.recalculateFromDate) l = AmCharts.getDate(l, a.dataDateFormat, "fff"), g = a.getClosestIndex(a.chartData, "time", l.getTime(), !0, 0, a.chartData.length), h = a.chartData.length - 1;
    ...
    getMinMax: function() {
        ...
        1 > c ? (this.maxDecCount = Math.abs(Math.log(Math.abs(c)) *
            Math.LOG10E), this.maxDecCount = Math.round(this.maxDecCount), this.step = AmCharts.roundTo(this.step, this.maxDecCount + 1)) : this.maxDecCount = 0;
    ...
    coordinateToValue: function(a) {
        ...
        var b = this.axisWidth,
            ...
            f = this.min,
            g = this.minReal;
        return !0 === this.logarithmic ? Math.pow(10, (e ? !0 === d ? (b - a) / c : a / c : !0 === d ? a / c : (b - a) / c) + Math.log(g) * Math.LOG10E) : !0 === d ? e ? f - (a - b) /
            c : a / c + f : e ? a / c + f : f - (a - b) / c
    },
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k, l, m, n) {
        ...
        var oa = a.counter,
            ...
            aa = a.offset,
            ba, sa;
        g ? (void 0 != g.id && (n = p.classNamePrefix + "-guide-" + g.id), ca = !0, isNaN(g.tickLength) || (A = g.tickLength), void 0 != g.lineColor && (I = g.lineColor), void 0 != g.color && (t = g.color), isNaN(g.lineAlpha) || (C = g.lineAlpha), isNaN(g.dashLength) || (D = g.dashLength), isNaN(g.lineThickness) || (B = g.lineThickness), !0 === g.inside && (T = !0), isNaN(g.labelRotation) || (m = g.labelRotation), isNaN(g.fontSize) ||
        ...
        "V" == Oa && (m = 0);
        var X;
        ca && (X = a.autoWrap && 0 === m ? AmCharts.wrappedText(z, c, t, r, q, ha, h, e, 0) : AmCharts.text(z, c, t, r, q, ha, h), ha = X.getBBox(), da = ha.width, Pa = ha.height);
        if ("H" == Oa) {
            if (0 <= b && b <= ra + 1 && (0 < A && 0 < y && b + k <= ra + 1 && (ba = AmCharts.line(z, [b + k, b + k], [0, A], w, y, B), x.push(ba)), 0 < C && (sa = AmCharts.line(z, [b, b + pa, b + pa], [U, U + ia, ia], I, C, B, D), x.push(sa))), v = 0, G = b, g && 90 == m && T && (G -= q), !1 === d ? (ha = "start", v = "bottom" == Z ? T ? v + A : v - A : T ? v - A : v + A, G += 3, e && (G += e / 2 - 3, ha = "middle"), 0 < m && (ha = "middle")) : ha = "middle", 1 == oa && 0 < S && !g && !l && Y < ra && (d = AmCharts.fitToBounds(b, 0, ra), Y = AmCharts.fitToBounds(Y, 0, ra), V = d - Y, 0 < V && (va = AmCharts.rect(z, V, a.height, H, S), va.translate(d - V + pa, ia), x.push(va))), "bottom" == Z ? (v += U + q / 2 + aa, T ? (0 < m ? (v = U - da / 2 * Math.sin(O) - A - 3, G += da / 2 * Math.cos(O) - 4 + 2) : 0 > m ? (v = U + da * Math.sin(O) - A - 3 + 2, G += -da * Math.cos(O) - Pa * Math.sin(O) -
                    4) : v -= A + q + 3 + 3, v -= ma) : (0 < m ? (v = U + da / 2 * Math.sin(O) + A + 3, G -= da / 2 * Math.cos(O)) : 0 > m ? (v = U + A + 3 - da / 2 * Math.sin(O) + 2, G += da / 2 * Math.cos(O)) : v += A + u + 3 + 3, v += ma)) : (v += ia + q / 2 - aa, G += pa, T ? (0 < m ? (v = da / 2 * Math.sin(O) + A + 3, G -= da / 2 * Math.cos(O)) : v += A + 3, v += ma) : (0 < m ? (v = -(da / 2) * Math.sin(O) - A - 6, G += da / 2 * Math.cos(O)) : v -= A + q + 3 + u + 3, v -= ma)), "bottom" == Z ? V = (T ? U - A - 1 : U + u - 1) + aa : (ja = pa, V = (T ? ia : ia - A - u + 1) - aa), f && (G += f), f = G, 0 < m && (f += da / 2 * Math.cos(O)), X && (q = 0, T && (q = da / 2 * Math.cos(O)), f + q > ra + 2 || 0 > f)) X.remove(), X = null
        } else {
            0 <= b && b <= U + 1 && (0 < A && 0 < y &&
                b + k <= U + 1 && (ba = AmCharts.line(z, [0, A], [b + k, b + k], w, y, B), x.push(ba)), 0 < C && (sa = AmCharts.line(z, [0, pa, ra + pa], [b, b + ia, b + ia], I, C, B, D), x.push(sa)));
            ha = "end";
            if (!0 === T && "left" == Z || !1 === T && "right" == Z) ha = "start";
            v = b - q / 2;
            1 == oa && 0 < S && !g && !l && (d = AmCharts.fitToBounds(b, 0, U), Y = AmCharts.fitToBounds(Y, 0, U), O = d - Y, va = AmCharts.polygon(z, [0, a.width, a.width, 0], [0, 0, O, O], H, S), va.translate(pa, d - O + ia), x.push(va));
            v += q / 2;
            "right" == Z ? (G += pa + ra + aa, v += ia, T ? (f || (v -= q / 2 + 3), G = G - (A + 4) - ma) : (G += A + 4 + u, v -= 2, G += ma)) : T ? (G += A + 4 - aa, f || (v -=
                q / 2 + 3), g && (G += pa, v += ia), G += ma) : (G += -A - u - 4 - 2 - aa, v -= 2, G -= ma);
            ba && ("right" == Z ? (ja += pa + aa + ra, V += ia, ja = T ? ja - u : ja + u) : (ja -= aa, T || (ja -= A + u)));
            f && (v += f);
            T = -3;
            "right" == Z && (T += ia);
            X && (v > U + 1 || v < T) && (X.remove(), X = null)
        }
        ba && (ba.translate(ja, V), AmCharts.setCN(p, ba, a.bcn + "tick"), AmCharts.setCN(p, ba, n, !0), g && AmCharts.setCN(p, ba, "guide"));
        !1 === a.visible && (ba && ba.remove(), X && (X.remove(), X = null));
        X && (X.attr({
                "text-anchor": ha
            }), X.translate(G, v), 0 !== m && X.rotate(-m, a.chart.backgroundColor), a.allLabels.push(X), this.label =
            X, AmCharts.setCN(p, X, a.bcn + "label"), AmCharts.setCN(p, X, n, !0), g && AmCharts.setCN(p, X, "guide"));
...
AmCharts.AmChart = AmCharts.Class({
    ...
    write: function(a) {
        if (a = "object" != typeof a ? document.getElementById(a) : a) {
            ...
            if (d)
                if (d = this.addLegend(d, d.divId), d.enabled) switch (d.position) {
                    case "bottom":
                        h.appendChild(b);
                        h.appendChild(c);
                        break;
    ...
    measure: function() {
        ...
        if (a) {
            ...
            f = Math.round(AmCharts.toCoordinate(this.height, d));
            (c != this.previousWidth || d != this.previousHeight) && 0 < a && 0 < f && (b.style.width = a + "px", b.style.height = f + "px",
                e && e.setSize(a, f), this.balloon = AmCharts.processObject(this.balloon, AmCharts.AmBalloon, this.theme), this.balloon.chart = this, this.balloon.setBounds(2, 2, a - 2, f));
            this.realWidth = a;
            this.realHeight = f;
            this.divRealWidth = c;
    ...
    brr: function() {
        ...
        if ("" != b || !0 === this.inIframe()) {
            var c = b = 0,
                d = this.realWidth,
                e = this.realHeight,
                f = this.type;
            if ("serial" == f || "xy" == f || "gantt" == f) b = this.marginLeftReal, c = this.marginTopReal, d = b + this.plotAreaWidth, e = c + this.plotAreaHeight;
            ...
            var h = f.offsetWidth,
                ...
                k = 5 + b,
                l = c + 5;
            "bottom-left" == a && (k = 5 + b, l = e - f - 3);
            "bottom-right" == a && (k = d - h - 5, l = e - f - 3);
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createXYGraph: function() {
        ...
        for (e = this.start; e <= this.end; e++) {
            var f =
                this.data[e].axes[c.id].graphs[this.id],
                g = f.values,
                h = g.x,
                k = g.y,
                g = c.getCoordinate(h),
                l = d.getCoordinate(k);
            !isNaN(h) && !isNaN(k) && (a.push(g), b.push(l), f.x = g, f.y = l, h = this.createBullet(f, g, l, e), k = this.labelText) && (f = this.createLabel(f, g, l, k), this.positionLabel(g, l, f, h), this.allBullets.push(f))
        }
    ...
    positionLabel: function(a, b, c, d, e, f) {
        ...
        if (d) {
            ...
            var p = k.columnGraphics,
                r = 0,
                q = 0;
            p && (r = p.x, q = p.y);
            var t = this.labelOffset;
            switch (g) {
                case "top":
                    b -= d.size / 2 + h.height / 2 + t;
                    break;
                case "right":
                    e =
                        "start";
                ...
                case "left":
                    ...
                    break;
                case "inside":
                    "column" == this.type && (f = !0, l ? m ? (e = "end", a = r - 3 - t) : (e = "start", a = r + 3 + t) : b = m ? q + 7 + t : q - 10 - t);
                    break;
                case "middle":
                    "column" == this.type && (f = !0, l ? a -= (a - r) / 2 + t - 3 : b -= (b - q) / 2 + t - 3)
            }
            ...
            c.translate(a, b);
            h = c.getBBox();
            !this.showAllValueLabels && p && f && (h.height > k.columnHeight ||
                h.width > k.columnWidth) && (c.remove(), c = !1);
            if (c && ("serial" == n.type || "gantt" == n.type))
                if (l) {
    ...
    createSerialGraph: function() {
        ...
        f.logarithmic && (fb =
            f.getCoordinate(f.minReal));
        this.minCoord = fb;
        this.resetBullet && (this.bullet = "none");
        if (!(T || "line" != g && "smoothedLine" != g && "step" != g || (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ia && void 0 == Ba || l))) {
            var Qa = Oa;
            Qa > f.max && (Qa = f.max);
            Qa < f.min && (Qa = f.min);
            ...
            r ? (da = n, Pa = Math.abs(Hb - Fa) + 1, qb = n, rb = Math.abs(fb - Fa) + 1, eb = pb = 0, f.reversed ? (X = 0, db = Fa) : (X = Fa, db = 0)) : (Pa = m, da = Math.abs(Hb - Fa) +
                1, rb = m, qb = Math.abs(fb - Fa) + 1, db = X = 0, f.reversed ? (eb = p, pb = Fa) : eb = Fa + 1)
        }
        var Ga = Math.round;
        this.pmx = Ga(X);
        this.pmy = Ga(pb);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < ca) {
                for (J = ca - 1; - 1 < J; J--)
                    if (G = d[J], v = G.axes[f.id].graphs[b],
                        ja = v.values.value, !isNaN(ja)) {
                        ca = J;
                        break
                    }
        ...
        var P = [],
            ...
            Ja = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == S || "100%" == S || this.fillToGraph) Ja = !0;
        ...
        for (J = ca; J <= oa; J++) {
            ...
            if (l && void 0 == this.openField)
                for (var tb = J + 1; tb < d.length && (!d[tb] || !(Ya = d[J + 1].axes[f.id].graphs[b]) || !Ya.values ||
                        (La = Ya.values.value, isNaN(La))); tb++);
            var R, N, L, ea, ka = NaN,
                F = NaN,
                E = NaN,
                M = NaN,
            ...
            if (Aa) {
                W = this.stackable && "none" != S && "3d" != S ? Aa.close : Aa.value;
                if ("candlestick" == g || "ohlc" ==
                    g) W = Aa.close, vb = Aa.low, Ca = f.getCoordinate(vb), ub = Aa.high, Da = f.getCoordinate(ub);
                la = Aa.open;
                E = f.getCoordinate(W);
                isNaN(la) || (K = f.getCoordinate(la), l && (La = la, la = K = NaN));
                l && (void 0 == this.openField ? Ya && (Ya.isNegative = La < W ? !0 : !1, isNaN(La) && (v.isNegative = !Ka)) : v.isNegative = La > W ? !0 : !1);
                ...
                var ka = G.x[pa.id],
                    ...
                    qa = Math.floor(V / 2) + Math.floor(Sa * V / 2),
                    Ea = qa,
                    kb = 0;
                "left" ==
                this.stepDirection && (kb = (2 * V + Sa * V) / 2, ka -= kb);
                "center" == this.stepDirection && (kb = V / 2, ka -= kb);
                "start" == this.pointPosition && (ka -= V / 2 + Math.floor(Sa * V / 2), qa = 0, Ea = Math.floor(V) + Math.floor(Sa * V));
                "end" == this.pointPosition && (ka += V / 2 + Math.floor(Sa * V / 2), qa = Math.floor(V) + Math.floor(Sa * V), Ea = 0);
                if (Jb) {
                    var xb = this.columnWidth;
                    isNaN(xb) || (qa *= xb, Ea *= xb)
                }
                T || (v.x = ka); - 1E5 > ka && (ka = -1E5);
                ka > m + 1E5 && (ka = m + 1E5);
                r ? (F = E, M = K, K = E = ka, isNaN(la) && !this.fillToGraph && (M = ia), Ma = Ca, Na = Da) : (M = F = ka, isNaN(la) && !this.fillToGraph && (K =
                    ia));
                if (!wb && W < la || wb && W < sa) v.isNegative = !0, Ia && (Ha = Ia), Wa && (Ra = Wa), void 0 != Ba && (za = Ba);
                Xa = !1;
                isNaN(W) || (l ? W > La ? (Ka && (Xa = !0), Ka = !1) : (Ka || (Xa = !0), Ka = !0) : v.isNegative = W < Oa ? !0 : !1, sa = W);
                void 0 != v.color && (Ha = v.color);
                v.fillColors && (Ha = v.fillColors);
                switch (g) {
                    case "line":
                        if (isNaN(W)) z || (this.drawLineGraph(x, u, P, Q), x = [], u = [], P = [], Q = []);
                        else {
                            ...
                            if (Xa || void 0 != v.lineColor ||
                                void 0 != v.fillColors || !isNaN(v.dashLength)) this.drawLineGraph(x, u, P, Q), x = [F], u = [E], P = [], Q = [], !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), l ? Ka ? (this.lineColorSwitched = ra, this.fillColorsSwitched = sb) : (this.lineColorSwitched = Ba, this.fillColorsSwitched = Ia) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors), this.dashLengthSwitched = v.dashLength;
                            v.gap && (this.drawLineGraph(x, u, P, Q), x = [], u = [], P = [], Q = [])
                        }
                        break;
                    case "smoothedLine":
                        if (isNaN(W)) z || (this.drawSmoothedGraph(x, u, P, Q), x = [],
                            u = [], P = [], Q = []);
                        else {
                            if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib) x.push(F), u.push(E), gb = F, hb = E;
                            xa = F;
                            ...
                            ga = E;
                            !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K));
                            void 0 == v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(x, u, P, Q), x = [F], u = [E], P = [], Q = [], !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched = v.dashLength);
                            v.gap && (this.drawSmoothedGraph(x, u, P, Q), x = [], u = [], P = [], Q = [])
                        }
                        break;
                    case "step":
                        if (!isNaN(W)) {
                            r ? (isNaN(w) || (x.push(w), u.push(E - qa)), u.push(E - qa), x.push(F), u.push(E + Ea), x.push(F), !Ja || isNaN(K) || isNaN(M) || (isNaN(A) || (P.push(A), Q.push(K - qa)), P.push(M), Q.push(K - qa), P.push(M), Q.push(K + Ea))) : (isNaN(y) || (u.push(y), x.push(w), u.push(y), x.push(F - qa)), x.push(F - qa), u.push(E), x.push(F + Ea), u.push(E), !Ja || isNaN(K) || isNaN(M) || (isNaN(C) || (P.push(M - qa), Q.push(C)), P.push(M - qa), Q.push(K), P.push(M + Ea), Q.push(K)));
                            w = F;
                            y = E;
                            A = M;
                            C = K;
                            ...
                            fa = F;
                            ga = E;
                            if (Xa || void 0 != v.lineColor || void 0 !=
                                v.fillColors || !isNaN(v.dashLength)) {
                                var Xb = x[x.length - 2],
                                    Yb = u[u.length - 2];
                                x.pop();
                                u.pop();
                            ...
                            if (1 >= this.periodSpan || 1 < this.periodSpan && F - w > qa + Ea) w =
                                y = NaN;
                            this.drawLineGraph(x, u, P, Q);
                            x = [];
                            u = [];
                    ...
                    case "column":
                        ...
                        if (!isNaN(W)) {
                            l || (v.isNegative = W < Oa ? !0 : !1);
                            v.isNegative && (Ia && (Ha = Ia), void 0 != Ba && (ta = Ba));
                            var Kb = f.min,
                                Lb = f.max;
                            if (!(W < Kb && la < Kb || W > Lb && la > Lb)) {
                                var ua;
                                if (r) {
                                    "3d" == S ? (N = E - (q / 2 - this.depthCount + 1) * (h + O) + O / 2 + H * Z, R = M + D * Z, ua = Z) : (N = Math.floor(E - (q / 2 - Z) * (h + O) + O / 2), R = M, ua = 0);
                                    L = h;
                                    xa = F;
                                    ya = N + h / 2;
                                    ...
                                    N < n && 0 < L && (na = new AmCharts.Cuboid(e, ea, L, D - a.d3x, H - a.d3y, Ha, Ra, Y, ta, U, ha, t, r, aa, Za, jb, ma), v.columnWidth = Math.abs(ea), v.columnHeight = Math.abs(L))
                                } else {
                                    "3d" == S ? (R = F - (q / 2 - this.depthCount + 1) * (h + O) + O / 2 + D * Z, N = K + H * Z, ua = Z) : (R = F - (q / 2 - Z) * (h + O) + O / 2, N = K, ua = 0);
                                    L = h;
                                    xa = R + h / 2;
                                    ya = E;
                                    ...
                                    N = AmCharts.fitToBounds(N,
                                        this.dy, n);
                                    ea += $b - N;
                                    ea = AmCharts.fitToBounds(ea, -N + H * Z, n - N);
                                    R < m + Z * D && 0 < L && (this.showOnAxis && (N -= H / 2), na = new AmCharts.Cuboid(e, L, ea, D - a.d3x, H - a.d3y, Ha, Ra, Y, ta, this.lineAlpha, ha, t, r, aa, Za, jb, ma), v.columnHeight = Math.abs(ea), v.columnWidth = Math.abs(L))
                                }
                            }
                            if (na && (wa = na.set, AmCharts.setCN(a, na.set, "graph-" + this.type), AmCharts.setCN(a, na.set, "graph-" + this.id), v.className && AmCharts.setCN(a, na.set, v.className, !0), v.columnGraphics = wa, wa.translate(R, N), this.columnsSet.push(wa), (v.url || this.showHandOnHover) && wa.setAttr("cursor",
                                    "pointer"), !T)) {
                                "none" == S && (I = r ? (this.end + 1 - J) * B - c : B * J + c);
                                "3d" == S && (r ? (I = (this.end + 1 - J) * B - c - 1E3 * this.depthCount, xa += D * this.columnIndex, fa += D * this.columnIndex, v.y += D * this.columnIndex) : (I = (B - c) * (J + 1) + 1E3 * this.depthCount, ya += H * this.columnIndex, ga += H * this.columnIndex, v.y += H * this.columnIndex));
                                if ("regular" == S || "100%" == S) I = r ? 0 < Aa.value ? (this.end + 1 - J) * B + c : (this.end + 1 - J) * B - c : 0 < Aa.value ? B * J + c : B * J - c;
                        ...
                        if (!isNaN(la) && !isNaN(W)) {
                            ...
                            if (r) {
                                if (N = E - h / 2, R = M, L = h, N + L > n && (L = n - N), 0 > N && (L += N, N = 0), N < n && 0 < L) {
                                    var yb, zb;
                                    W > la ? (yb = [F, Na], zb = [M, Ma]) : (yb = [M, Na], zb = [F, Ma]);
                                    !isNaN(Na) && !isNaN(Ma) && E < n && 0 < E && (Ta = AmCharts.line(e, yb, [E, E], ta, U, Y), $a = AmCharts.line(e, zb, [E, E], ta, U, Y));
                                    ea = F - M;
                                    na = new AmCharts.Cuboid(e, ea, L, D, H, Ha, Va, Y, ta, U, ha, t, r, aa, Za, jb, ma)
                                }
                            } else if (R = F - h / 2, N = K + Y / 2, L = h, R + L > m && (L = m - R), 0 > R && (L +=
                                    R, R = 0), ea = E - K, R < m && 0 < L) {
                                wb && W >= la && (Ra = 0);
                                var na = new AmCharts.Cuboid(e, L, ea, D, H, Ha, Ra, Y, ta, U, ha, t, r, aa, Za, jb, ma),
                                    Ab, Bb;
                                W > la ? (Ab = [E, Da], Bb = [K, Ca]) : (Ab = [K, Da], Bb = [E, Ca]);
                                !isNaN(Da) && !isNaN(Ca) && F < m && 0 < F && (Ta = AmCharts.line(e, [F, F], Ab, ta, U, Y), $a = AmCharts.line(e, [F, F], Bb, ta, U, Y), AmCharts.setCN(a, Ta, this.bcn + "line-high"), v.className && AmCharts.setCN(a, Ta, v.className, !0), AmCharts.setCN(a, $a, this.bcn + "line-low"), v.className && AmCharts.setCN(a, $a, v.className, !0))
                            }
                            na && (wa = na.set, v.columnGraphics = wa, ba.push(wa),
                                wa.translate(R, N - Y / 2), (v.url || this.showHandOnHover) && wa.setAttr("cursor", "pointer"), Ta && (ba.push(Ta), ba.push($a)), xa = F, ya = E, r ? (ga = E, fa = F, "open" == k && (fa = M), "high" == k && (fa = Na), "low" == k && (fa = Ma)) : (ga = E, "open" == k && (ga = K), "high" == k && (ga = Da), "low" == k && (ga = Ca), fa = F), T || (v.x = r ? N + L / 2 : R + L / 2, this.animateColumns(na, J, F, M, E, K), this.addListeners(wa, v)))
                        }
                        break;
                    case "ohlc":
                        if (!(isNaN(la) || isNaN(ub) || isNaN(vb) || isNaN(W))) {
                            var Mb = e.set();
                            ba.push(Mb);
                            W < la && (v.isNegative = !0, void 0 != Ba && (za = Ba));
                            var lb, mb, nb;
                            if (r) {
                                var Cb =
                                    E - h / 2,
                                ...
                                mb = AmCharts.line(e, [M, M], [Cb, Nb], za, U, Y, aa);
                                0 < E && E < n && (lb = AmCharts.line(e, [Ma, Na], [E, E], za, U, Y, aa));
                                nb = AmCharts.line(e, [F, F], [Nb, Db], za, U, Y, aa);
                                ga = E;
                                fa = F;
                                "open" == k && (fa = M);
                                "high" == k && (fa = Na);
                                ...
                                mb = AmCharts.line(e, [Eb, Ob], [K, K], za, U, Y, aa);
                                0 < F && F < m && (lb = AmCharts.line(e, [F, F], [Ca, Da], za, U, Y, aa));
                                nb = AmCharts.line(e, [Ob, Fb], [E, E], za, U, Y, aa);
                                ga = E;
                                "open" == k && (ga = K);
                                "high" == k && (ga = Da);
                                "low" == k && (ga = Ca);
                ...
                if (!T && !isNaN(W)) {
                    ...
                    if (this.end - this.start <= Pb || 0 === Pb) {
                        var Qb = this.createBullet(v, fa, ga, J),
                            Rb = this.labelText;
                        if (Rb &&
                            Qb) {
                            var Gb = this.createLabel(v, fa, ga, Rb);
                            (Gb = this.positionLabel(xa, ya, Gb, Qb, L, ea)) && this.allBullets.push(Gb)
                        }
                        if ("regular" == S || "100%" == S) {
                            var Sb = f.totalText;
                            if (Sb) {
                                var Ua = this.createLabel(v, 0, 0, Sb, f.totalTextColor);
                                ...
                                r ? (bb = E, ab = 0 > W ? F - Ub / 2 - 2 - cb - ob : F + Ub / 2 + 3 + cb + ob) : (ab = F, bb = 0 > W ? E + Vb / 2 + cb + ob : E - Vb / 2 - 3 - cb - ob);
                                Ua.translate(ab, bb);
                                f.totals[J] =
                                    Ua;
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(x, u, P, Q) : this.drawLineGraph(x, u, P, Q), T || this.launchAnimation();
    ...
    animateColumns: function(a, b, c, d, e, f) {
        ...
        0 < c && !g.animationPlayed && (g.seqAn ? (a.set.hide(), g.animationArray.push(a), a = setTimeout(function() {
            ...
            1) * (b - g.start) * 1E3), g.timeOuts.push(a)) : g.animate(a))
    },
    ...
    positiveClip: function(a) {
        a.clipRect(this.pmx, this.pmy, this.pmw,
            this.pmh)
    },
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            void 0 === t || e.useNegativeColorIfDown || (n = AmCharts.line(h, a, b, t, r, n, z, !1, !0), AmCharts.setCN(g, n, e.bcn + "stroke"), AmCharts.setCN(g, n, e.bcn + "stroke-negative"),
                l.push(n));
            if (0 < f || 0 < u)
                if (n = a.join(";").split(";"), r = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), r = b.concat(d)) : e.rotate ? (r.push(r[r.length - 1]), n.push(w), r.push(r[0]), n.push(w), r.push(r[0]), n.push(n[0])) : (n.push(n[n.length - 1]), r.push(w), n.push(n[0]), r.push(w), n.push(a[0]), r.push(r[0])) : "xy" == m && (b = e.fillToAxis) && (AmCharts.isString(b) && (b = g.getValueAxisById(b)), "H" == b.orientation ? (w = "top" == b.position ? 0 : b.viH, n.push(n[n.length - 1]), r.push(w), n.push(n[0]),
                        r.push(w), n.push(a[0]), r.push(r[0])) : (w = "left" == b.position ? 0 : b.viW, r.push(r[r.length - 1]), n.push(w), r.push(r[0]), n.push(w), r.push(r[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(h, n, r, q, f, 1, "#000", 0, a), b.pattern(e.pattern), AmCharts.setCN(g, b, e.bcn + "fill"), k.push(b)), x || void 0 !== t) isNaN(u) && (u = f), x || (x = t), h = AmCharts.polygon(h, n, r, x, u, 1, "#000", 0, a), AmCharts.setCN(g, h, e.bcn + "fill"), AmCharts.setCN(g, h, e.bcn + "fill-negative"), h.pattern(e.pattern), l.push(h), l.click(function(a) {
    ...
    drawSmoothedGraph: function(a, b, c, d) {
        if (1 < a.length) {
            ...
            0 < n && (l = a.join(";").split(";"),
                p = b.join(";").split(";"), m = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), l = a.concat(c), p = b.concat(d)) : (this.rotate ? (m += " L" + x + "," + b[b.length - 1], m += " L" + x + "," + b[0]) : (m += " L" + a[a.length - 1] + "," + x, m += " L" + a[0] + "," + x), m += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(g, l, p, NaN, 0, 0, r, n, e, m), AmCharts.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern), h.push(c.path), t || void 0 !== q) && (z || (z = n), t || (t = q), a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, t, z, e, m), a.path.pattern(this.pattern), AmCharts.setCN(f,
                a, this.bcn + "fill"), AmCharts.setCN(f, a, this.bcn + "fill-negative"), k.push(a.path));
            this.applyMask(k, h)
        }
    },
    ...
    handleRollOver: function(a, b) {
        if (a) {
            ...
            d = this.showBalloon;
            !c.chartCursor || "serial" != c.type && "gantt" != c.type || (d = !1, !c.chartCursor.valueBalloonsEnabled && this.showBalloon &&
                (d = !0));
            if (d) {
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    draw: function() {
        ...
        d || (d = b.valueAxes[0]);
        a.valueLineAxis = d;
        a.valueLineBalloonEnabled && (d = new AmCharts.AmBalloon, a.vaBalloon = d, AmCharts.copyProperties(c,
            d), d.animationDuration = 0, a.rotate || (d.pointerOrientation = "H"));
    ...
    createCursor: function() {
        ...
        this.line = e;
        (f = this.fullRectSet) ? (f.push(e), f.translate(this.x,
            this.y)) : this.set.push(e);
    ...
    createCrosshair: function() {
        var a = this.cursorAlpha,
            ...
            a = AmCharts.line(b, [0, this.width], [0, 0], this.cursorColor,
                a, 1);
    ...
    detectMovement: function() {
        ...
        if (a.mouseIsOver) {
            var b = a.mouseX - this.x,
                c = a.mouseY - this.y; - .5 < b && b < this.width + 1 && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, (this.valueLineEnabled || this.valueLineBalloonEnabled) &&
                this.updateVLine(b, c), this.setPosition()) : this.rolledOver && (this.handleMouseOut(), this.rolledOver = !1)
    ...
    updateVLine: function(a, b) {
        ...
        if ((c || d) && !this.panning && !this.drawing) {
            ...
            if (d && !isNaN(f) && this.prevLineValue != f) {
                ...
                this.setBalloonPosition(d, e, c, !g);
                d.showBalloon(h)
            }
    ...
    updateCrosshair: function() {
        ...
        0 < this.cursorAlpha && (d.show(), e.show(), d.translate(b, 0), e.translate(0,
            c));
    ...
    updateSelectionSize: function(a, b) {
        ...
        var c = this.selectionPosX,
            ...
            h = this.height;
        isNaN(a) || (c > a && (e = a, g = c -
            a), c < a && (e = c, g = a - c), c == a && (e = a, g = 0), g += this.extraWidth, e -= this.extraWidth / 2);
    ...
    arrangeBalloons2: function() {
        ...
        for (e = 0; e < f; e++) {
            ...
            var h = g.bottom - g.yPos,
                k = f - e - 1;
            0 < e && b - h < d + 3 && (g.setBounds(c, d + 3, c + this.width, d + h + 3), g.prevX = this.prevX[k], g.prevY = this.prevY[k], g.prevTX =
                this.prevTX[k], g.prevTY = this.prevTY[k], g.draw());
            g.set && g.set.show();
    ...
    zoom: function(a, b, c, d) {
        ...
        if (this.fullWidth) {
            ...
            this.line =
                AmCharts.rect(this.container, b, c, this.cursorColor, this.cursorAlpha, 0);
    ...
    hideCursor: function(a) {
        void 0 === a && (a = !0);
        this.leaveCursor || (this.hideObj(this.set), this.hideObj(this.categoryBalloon), this.hideObj(this.line),
    ...
    setPosition: function(a, b, c) {
        void 0 === b && (b = !0);
        if ("cursor" == this.type) {
            if (this.tempPosition = NaN, AmCharts.ifArray(this.data)) isNaN(a) &&
                ...
                if (c.mouseIsOver || A || C || this.forceShow)
                    if (this.forceShow = !1, C) {
                        ...
                        0 !== e && (h = {
                            type: "zoomed",
                            target: this
                        }, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > w && (e = w - c), A + e < u && (e = u - A), h.start = Math.round(A + e), h.end = Math.round(c + e), this.fire(h.type, h)) : I + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = I + e, this.fire(h.type, h)))
                    } else {
                        ...
                        if (0 < this.cursorAlpha) {
                            ...
                            0 < z && !this.zooming ? isNaN(this.previousX) ? D.translate(u, w) : (D.translate(this.previousX, this.previousY), D.animate({
                                translate: u + "," + w
                            }, z, "easeOutSine")) : D.translate(u, w);
                            this.previousX = u;
                            this.previousY = w;
                            D.show()
                        }
                        ...
                        A && (d &&
                            D.hide(), t ? this.updateSelectionSize(NaN, q) : this.updateSelectionSize(q, NaN));
                        z = !0;
                        A && (z = !1);
                        ...
                        if (this.oneBalloonOnly) {
                            q =
                                Infinity;
                            for (g = 0; g < B.length; g++) u = B[g], u.showBalloon && !u.hidden && u.balloonText && (w = r.axes[u.valueAxis.id].graphs[u.id], x = w.y, isNaN(x) || (t ? Math.abs(e - x) < q && (q = Math.abs(e - x), I = u) : Math.abs(f - x) < q && (q = Math.abs(f - x), I = u)));
                        ...
                        if (a != this.previousIndex || I != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                                ...
                                for (g = 0; g < B.length; g++)
                                    if (u =
                                        B[g], x = NaN, (!this.oneBalloonOnly || u == I) && u.showBalloon && !u.hidden && u.balloonText && ("step" == u.type && "left" == u.stepDirection && (r = this.data[a + 1]), r)) {
                                        ...
                                        if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length)
                                            for (q = a + 1; q < this.data.length; q++)
                                                if (d = this.data[q])
                                                    if (w = d.axes[u.valueAxis.id].graphs[u.id], x = w.y, !isNaN(x)) break;
                                        if (!isNaN(x)) {
                                            d = w.x;
                                            k = !0;
                                            if (t) {
                                            ...
                                            k && (k = this.graphBulletSize, D = this.graphBulletAlpha,
                                                ...
                                                (k.color = u.balloonTextColor), k.setPosition(q + l, d + m), q = c.formatString(u.balloonText, w, !0), (d = u.balloonFunction) && (q = d(w, u).toString()), "" !== q && (t ? k.showBalloon(q) : (k.text = q, k.show = !0), z.push({
                                                    yy: x,
                                                    balloon: k
                        ...
                        b ? (h = {
                            type: "changed"
                        }, h.index = a, h.chart = this.chart, h.zooming = A, h.mostCloseGraph = I, h.position = t ? f : e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
    ...
    setBalloonPosition: function(a, b, c, d) {
        ...
        var g = this.chart,
            ...
            m = this.width,
            n = this.height;
        d ? (f && ("right" == e ? a.setBounds(k, l + g, k + m + h, l + c + g) : a.setBounds(k, l + g, k + m + h, l + c)), "right" == e ? f ? a.setPosition(k + m + h, l + c + g) : a.setPosition(k + m + h + b, l + c + g) : f ? a.setPosition(k, l + c) : a.setPosition(k - b, l + c)) : "top" == e ? f ? a.setPosition(k +
            c + h, l + g) : a.setPosition(k + c + h, l + g - b + 1) : f ? a.setPosition(k + c, l + n) : a.setPosition(k + c, l + n + b - 1)
    },
    setBalloonBounds: function(a, b, c) {
        var d = b.position,
            ...
            n = this.width,
            p = this.height;
        c ? (e && (a.pointerWidth = 0), "right" == d ? e ? a.setBounds(l, m + h, l + n + k, m + p + h) : a.setBounds(l + n + k + f, m + h, l + n + 1E3, m + p + h) : e ? a.setBounds(l, m, n + l, p + m) : a.setBounds(-1E3, -1E3, l - g - f, m + p + 15)) : (a.maxWidth = n, b.parseDates && (g = 0, a.pointerWidth = 0), "top" == d ? e ? a.setBounds(l +
            k, m + h, n + k + l, p + m) : a.setBounds(l + k, -1E3, n + k + l, m + h - g - f) : e ? a.setBounds(l, m, n + l, p + m - g) : a.setBounds(l, m + p + g + f - 1, l + n, m + p + g + f))
    },
    ...
    draw: function() {
        ...
        if (a.enabled) {
            ...
            if ((a.height = g) && f) {
                ...
                f = d.pathToImages;
                c ? (h = f + a.dragIcon + "H.png", f = a.dragIconWidth, c = a.dragIconHeight) : (h = f + a.dragIcon + ".png", c = a.dragIconWidth, f = a.dragIconHeight);
                g = b.image(h, 0, 0, c, f);
    ...
    handleBgClick: function() {
        ...
        if (!a.resizingRight && !a.resizingLeft) {
            ...
            a.updateOnReleaseOnly ? (a.skipEvent = !1, e.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (c = Math.round(c), l ? e.animate({
                    ...
                    x: c
                }, d, ">"), a.forceClip = !0, clearTimeout(a.forceTO),
            ...
            if (l = a.graph) {
                ...
                for (r = 0; r < c.length; r++) {
                    var q = c[r].axes[p.id].graphs[l.id].values,
                        t;
                    for (t in q)
                        if (q.hasOwnProperty(t) && "percents" != t && "total" != t) {
                            var z = q[t];
                            z < f && (f = z);
                            z > g && (g = z)
                        }
    ...
    draw: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                "H" != x ? (C = a - B / 2, b < h + w + 10 && "down" != x ? (I = !0, d && (b += y), y = b + z, this.deltaSignY = -1) : (d && (b -= y), y = b - w - z, this.deltaSignY = 1)) : (2 * z > w && (z = w / 2), y = b - w / 2, a < g + (k - g) / 2 ? (C = a + z, this.deltaSignX = -1) : (C = a - B - z, this.deltaSignX = 1));
                y + w >= l && (y = l - w);
                y < h && (y = h);
                C < g && (C = g);
                C + B > k && (C = k - B);
                ...
                0 < u || 0 === z ? (0 < t && (a = AmCharts.rect(e, B, w, n, 0, q + 1, D, t, this.cornerRadius), AmCharts.isModern ?
                    a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, B, w, n, this.fillAlpha, q, p, this.borderAlpha, this.cornerRadius), this.showBullet && (S = AmCharts.circle(e, H, r, this.fillAlpha), f.push(S))) : (r = [], u = [], "H" != x ? (g = a - C, g > B - z && (g = B - z), g < z && (g = z), r = [0, g - z, a - C, g + z, B, B, 0, 0], u = I ? [0, 0, b - y, 0, 0, w, w, 0] : [w, w, b - y, w, w, 0, 0, w]) : (r = b - y, r > w - z && (r = w - z), r < z && (r = z), u = [0, r - z, b - y, r + z, w, w, 0, 0], r = a < g + (k - g) / 2 ? [0, 0, C < a ? 0 : a - C, 0, 0, B, B, 0] : [B, B, C + B > a ? B : a - C, B, B, 0, 0, B]), 0 < t && (a = AmCharts.polygon(e, r, u, n, 0, q, D, t), a.translate(1, 1),
                ...
                this.bottom = y + w + 1;
                this.yPos = n.y + y;
                S && S.translate(this.pointToX - C + e, b - y);
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    ...
    parseSerialData: function(a) {
        ...
        if (a) {
            ...
            var n, p, r = {},
                q;
            f && (c = AmCharts.extractPeriod(h.minPeriod),
                n = c.period, p = c.count, q = AmCharts.getPeriodDuration(n, p));
            var t = {};
            this.lookupTable = t;
            ...
            for (z = 0; z < a.length; z++) {
                ...
                w.dataContext = y;
                w.category = g ? g(c, y, h) : String(c);
                k && (w.forceShow = y[k]);
                m && (w.className = y[m]);
                l && (w.labelColor = y[l]);
                t[y[e]] = w;
                if (f && (h.categoryFunction ? c = h.categoryFunction(c, y, h) : (!x || c instanceof Date || (c = c.toString()), c = AmCharts.getDate(c, x, h.minPeriod)), c = AmCharts.resetDateToMin(c, n, p, h.firstDayOfWeek), w.category = c,
                        w.time = c.getTime(), isNaN(w.time))) continue;
                ...
                for (C = 0; C < A.length; C++) {
                    ...
                    for (I = 0; I < b.length; I++) {
                        ...
                        var D = c.id,
                            H = 1.1;
                        isNaN(c.gapPeriod) || (H = c.gapPeriod);
                        var S = c.periodValue;
                        if (c.valueAxis.id == B) {
                            w.axes[B].graphs[D] = {};
                            var ca = {};
                            ...
                            var oa = y;
                            c.dataProvider && (oa = d);
                            ca.values = this.processValues(oa, c, S);
                            !c.connect && u && u[D] && w.time - r[D] >= q * H && (u[D].gap = !0);
                            this.processFields(c, ca, oa);
    ...
    processValues: function(a, b, c) {
        ...
        for (var g = "value error open close low high".split(" "), h = 0; h < g.length; h++) {
            var k = g[h];
            "value" != k && "error" != k && f && (c = k.charAt(0).toUpperCase() + k.slice(1));
            var l = a[b[k + "Field"] + c];
            e = Number(l);
            isNaN(e) || (d[k] = e);
            "date" == b.valueAxis.type &&
                void 0 != l && (e = AmCharts.getDate(l, b.chart.dataDateFormat), d[k] = e.getTime())
        }
        return d
    },
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    clickSlice: function(a, b, c) {
        isNaN(a) || (a = this.chartData[a]);
        a.pulled ?
            this.pullSlice(a, 0) : this.pullSlice(a, 1);
        AmCharts.getURL(a.url, this.urlTarget);
        c || (a = {
            type: "clickSlice",
            dataItem: a,
...
AmCharts.AmRectangularChart = AmCharts.Class({
    ...
    resetMargins: function() {
        ...
        if ("xy" == this.type) {
            ...
            (b = this.categoryAxis) && !b.ignoreAxisWidth && (b.setOrientation(!this.rotate), b.fixAxisPosition(), b.fixAxisPosition(),
                a[b.position] = !0)
        }
    ...
    updateMargins: function() {
        ...
        this.fixMargins &&
            !this.fixMargins.top && (this.marginTopReal += a);
    ...
    getScrollbarPosition: function(a, b, c) {
        a.position = b ? "bottom" == c || "left" == c ? "bottom" : "top" : "top" == c ||
            "right" == c ? "bottom" : "top"
    },
    updateChartScrollbar: function(a, b) {
        if (a) {
            ...
            var c = this.marginTopReal,
                ...
                g = this.dy,
                h = a.offset;
            "top" == a.position ? b ? (a.y = c, a.x = d - e - h) : (a.y = c - e + g - h, a.x = d + f) : b ? (a.y = c + g, a.x = d + this.plotAreaWidth + f + h) : (a.y = c + this.plotAreaHeight + h, a.x = this.marginLeftReal)
        }
    },
    showZB: function(a) {
        var b = this.zbSet;
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function() {
        ...
        var b = a.chart,
            ...
            w = b.dataDateFormat;
        h && (k && (k = AmCharts.getDate(k, w, "fff"), a.initialDate = k, d = h.dateToCoordinate(k)), l && (d = h.categoryToCoordinate(l)), m && (m = AmCharts.getDate(m, w, "fff"), a.finalDate = m, e = h.dateToCoordinate(m)), n && (e = h.categoryToCoordinate(n)));
        r && !u && (isNaN(q) || (d = r.getCoordinate(q)), isNaN(t) || (e = r.getCoordinate(t)));
        p && !u && (isNaN(z) || (f = p.getCoordinate(z)), isNaN(x) || (g = p.getCoordinate(x)));
        isNaN(d) || isNaN(e) || isNaN(f) || isNaN(f) || (b.rotate ? (h = [f, g], e = [d, e]) : (h = [d, e], e = [f, g]), f =
            a.lineColor, d = AmCharts.line(c, h, e, f, a.lineAlpha, a.lineThickness, a.dashLength), g = h, k = e, n = h[1] - h[0], p = e[1] - e[0], 0 === n && (n = .01), 0 === p && (p = .01), l = n / Math.abs(n), m = p / Math.abs(p), p = n * p / Math.abs(n * p) * Math.sqrt(Math.pow(n, 2) + Math.pow(p, 2)), n = Math.asin(n / p), p = 90 * Math.PI / 180 - n, n = Math.abs(5 * Math.cos(p)), p = Math.abs(5 * Math.sin(p)), g.push(h[1] - l * p, h[0] - l * p), k.push(e[1] + m * n, e[0] + m * n), h = AmCharts.polygon(c, g, k, f, .005, 0), c = c.set([h, d]), c.translate(b.marginLeftReal, b.marginTopReal), b.trendLinesSet.push(c), AmCharts.setCN(b,
                d, "trend-line"), AmCharts.setCN(b, d, "trend-line-" + a.id), a.line = d, a.set = c, h.mouseup(function() {
                a.handleLineClick()
            }).mouseover(function() {
                a.handleLineOver()
            }).mouseout(function() {
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    0 < k && (H = " M" + t + "," + (x + k) + " L" + u + "," + (w + k), q ? (D || (H += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + u + "," + (w + k) + "," + y + "," + (A + k)), H += " L" + C + "," + (z + k), 0 < h && (D || (H += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) +
        "," + C + "," + (k + z) + "," + t + "," + (k + x)))) : (H += " A" + f + "," + g + ",0," + I + ",1," + y + "," + (A + k) + " L" + C + "," + (z + k), 0 < h && (H += " A" + h + "," + r + ",0," + I + ",0," + t + "," + (x + k))), H = a.path(H + " Z", void 0, void 0, "1000,1000").attr(B), d.push(H), H = a.path(" M" + t + "," + x + " L" + t + "," + (x + k) + " L" + u + "," + (w + k) + " L" + u + "," + w + " L" + t + "," + x + " Z", void 0, void 0, "1000,1000").attr(B), k = a.path(" M" + y + "," + A + " L" + y + "," + (A + k) + " L" + C + "," + (z + k) + " L" + C + "," + z + " L" + y + "," + A + " Z", void 0, void 0, "1000,1000").attr(B), d.push(H), d.push(k));
    q ? (D || (e = " A" + p(b - f) + "," + p(c - g) +
        "," + p(b + f) + "," + p(c + g) + "," + p(u) + "," + p(w) + "," + p(y) + "," + p(A)), f = " M" + p(t) + "," + p(x) + " L" + p(u) + "," + p(w) + e + " L" + p(C) + "," + p(z)) : f = " M" + t + "," + x + " L" + u + "," + w + (" A" + f + "," + g + ",0," + I + ",1," + y + "," + A) + " L" + C + "," + z;
    0 < h && (q ? D || (f += " B" + (b - h) + "," + (c - r) + "," + (b + h) + "," + (c + r) + "," + C + "," + z + "," + t + "," + x) : f += " A" + h + "," + r + ",0," + I + ",0," + t + "," + x);
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function() {
        ...
        for (w = 0; w < x.length; w++) {
            var I = x[w];
            this.reversedOrder && (I = x[x.length - w - 1]);
            u = I.getBBox();
            var D;
        ...
        u = z.getBBox();
        k = u.height + 2 * l - 1;
        "left" == a || "right" == a ? (m = u.width + 2 * f, h = m + b + c, g.style.width = h + "px", this.ieW = h) : m = h - b - c - 1;
        ...
        if ("top" == a || "bottom" == a || "absolute" ==
            a || "outside" == a) "center" == this.align ? b = f + (m - u.width) / 2 : "right" == this.align && (b = f + m - u.width);
        z.translate(b, l + 1);
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings) {
                ...
                if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-stroke"), g.push(m), a.bullet && (a.hidden ||
                    (d = a.bulletColorR), m = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (AmCharts.setCN(b, m, "graph-bullet"), m.translate(l + 1, l / 2), g.push(m)), p = 0, m = l, n = l / 3;
                else {
                    var r;
            ...
            } else h ? (b.path && (h = b.path +
                h), g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c, d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l / 2, l / 2);
            ...
            (f = this.switchType) && "none" != f && ("x" == f ? (c = this.createX(), c.translate(l / 2, l / 2)) : c = this.createV(), c.dItem = a, !0 !== a.hidden ? "x" == f ? c.hide() : c.show() : "x" != f && c.hide(), this.switchable ||
                c.hide(), this.addListeners(c, a), a.legendSwitch = c, k.push(c), AmCharts.setCN(b, c, "legend-switch"));
            f = this.color;
            ...
            var q;
            d && (d = AmCharts.fixBrakes(d), a.legendTextReal = d, q =
                this.labelWidth, q = isNaN(q) ? AmCharts.text(this.container, d, f, b.fontFamily, c, "start") : AmCharts.wrappedText(this.container, d, f, b.fontFamily, c, "start", !1, q, 0), AmCharts.setCN(b, q, "legend-label"), q.translate(this.lx + m, this.ly), k.push(q), b = q.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
    ...
    createValue: function(a) {
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            b.forceWidth && (e = b.labelWidth);
            b.equalWidths || (b.valueAlign = "left");
            "left" == b.valueAlign && (e = a.legendEntry.getBBox().width);
            var f = e;
            if (b.valueText && 0 < b.valueWidth) {
                var g = b.color;
                b.useMarkerColorForValues && (g = a.color, a.legendKeyColor && (g =
                    a.legendKeyColor()));
...
AmCharts.getDate = function(a, b, c) {
    return date = a instanceof Date ? AmCharts.newDate(a, c) : b && isNaN(a) ? AmCharts.stringToDate(a, b) : new Date(a)
};
AmCharts.newDate = function(a, b) {
    return b && "fff" != b ? new Date(a) : AmCharts.useUTC ? new Date(a.getUTCFullYear(), a.getUTCMonth(), a.getUTCDate(), a.getUTCHours(), a.getUTCMinutes(), a.getUTCSeconds(), a.getUTCMilliseconds()) : new Date(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds(), a.getMilliseconds())
};
